...
import com.xiii_lab.spacex.launches.LaunchesListDestination
import com.xiii_lab.spacex.navigation.LaunchesList
...
internal fun SpaceXHostScreen() {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            LaunchesList.route(this) {
                LaunchesListDestination()
            }
